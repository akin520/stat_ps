...
$count = $_.count
"(1,1,1,1,1,0,'$Date','$Hours',$a,$count)"
}
$sqlmore+=$sql1
...
$cc.CommandText="INSERT INTO [KysdStatisticsDB].[dbo].[Download1Hour] ([GamesID],[OSID],[OSVersionID],[ChannelID],[SpreadChannelID],[SpreadSubChannelID],[Date],[Hour],[DownLoadTypeID],[Count]) VALUES $sqltmp"
$da=New-Object System.Data.SqlClient.SqlDataAdapter($cc)
$dt1=New-Object System.Data.DataTable
